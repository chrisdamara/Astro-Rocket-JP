...
gallery:
  - src: "../../assets/projects/03.jpg"
    alt: "Just Pixel — screenshot 03."
  - src: "../../assets/projects/04.jpg"
    alt: "Just Pixel — screenshot 04."
  - src: "../../assets/projects/02.jpg"
    alt: "Just Pixel — screenshot 02."
  - src: "../../assets/projects/05.jpg"
    alt: "Just Pixel — screenshot 05."
  - src: "../../assets/projects/01.jpg"
    alt: "Just Pixel — screenshot 01."
  - src: "../../assets/projects/06.jpg"
    alt: "Just Pixel — screenshot 06."
  - src: "../../assets/projects/07.jpg"
    alt: "Just Pixel — screenshot 07."
  - src: "../../assets/projects/08.jpg"
    alt: "Just Pixel — screenshot 08."
  - src: "../../assets/projects/09.jpg"
    alt: "Just Pixel — screenshot 09."
---
...
[Just Pixel](https://astro.build/themes/details/astro-rocket/), created by Just Pixel — web designer and developer from Veghel, the Netherlands — is a production-ready Astro 6 starter that ships as a **complete, styled website**, not a blank slate. Clone it, update the text, go live. Everything else is already done.
...
The theme switcher is one of Just Pixel's most satisfying details. Twelve colour themes — **Orange, Amber, Lime, Emerald, Teal, Cyan, Sky, Blue, Indigo, Violet, Purple, and Magenta** — toggle instantly from a pill in the header. Click a swatch and every button, link, badge, progress bar, scroll-progress arc, logo monogram, blog cover gradient, and accent on the page updates in a single frame. No waiting, no code changes, no deploy.

The secret is CSS custom properties scoped to `data-theme` attributes on `<html>`. The browser does all the work — the server never needs to know. The full token system — how colours, spacing, and typography are wired together — is covered in [How Just Pixel's Design System Works](/blog/design-system-color-tokens).
...
Most starters ship three meta tags and call it SEO. Just Pixel ships the complete implementation:
...
The full setup — what each piece does, how to configure it, and what rich results it unlocks — is in [SEO in Just Pixel](/blog/seo-in-astro-rocket).

## Internationalization — Native, Opt-In

As of **v1.3.0**, internationalization is built into Just Pixel itself — no upstream CLI, no project regeneration, no content restructure. Flip `enabled: true` in `src/config/i18n.config.ts` and the theme switches on:
...
A full technical breakdown of every animation layer is in [Animations in Just Pixel](/blog/animations-in-astro-rocket).
...
Just Pixel ships with first-party configuration for **Vercel**, **Netlify**, and **Cloudflare Pages** — `vercel.json`, `netlify.toml`, and `wrangler.toml` are all in the repo, each with security headers pre-configured. CI runs lint, type-check, and build on every push via GitHub Actions.
...
Just Pixel is open source under the MIT licence and submitted to the official Astro themes directory. It's a fork of and a tribute to [Velocity](https://github.com/southwellmedia/velocity) by Southwell Media — the foundation it builds on. If it saves you a week of setup, [a star on GitHub](https://github.com/hansmartensdev/Astro-Rocket) is the best way to say thanks.
